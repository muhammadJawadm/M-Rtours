...
const Counter2 = () => {
    ...
    return (
        <section className="cta-offer-section section-padding fix bg-cover" data-background="/assets/img/about/Discount Pic1.png" >
                    ...
                    <div className="row g-4">
                        <div className="col-lg-6">
                            <div className="offer-content">
                                <div className="section-title">
                                    <span className="sub-title text-white wow fadeInUp">Submit your Hajj Application Today</span>
                                    <h2 className="text-white wow fadeInUp wow" data-wow-delay=".2s">
                                        and Get a discount <br/>
                        ...
                        <div className="col-lg-6">
                            <div className="offer-image">
                                <Image src="/assets/img/about/Discount Pic2.png" alt="img" width={386} height={386}   />
