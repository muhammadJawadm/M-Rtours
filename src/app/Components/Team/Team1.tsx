...
const Team1 = () => {
    ...
    const teamContent = [
        {img:'/assets/img/about/Tour Guide 1.png', name:'Esther howard', content:'Tourist Guide',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/about/Tour Guide 2.png', name:'Leslie Alexander', content:'Tourist Guide',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/about/Tour Guide 3.png', name:'Theresa Web', content:'Tourist Guide',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
        {img:'/assets/img/about/Tour Guide 4.png', name:'Floyd Miles', content:'Tourist Guide',instagram:'#',facebook:'#',twitter:'#',linkedin:'#'},
      ];
