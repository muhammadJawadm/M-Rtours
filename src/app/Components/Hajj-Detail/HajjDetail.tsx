...
const HajjDetails: React.FC<HajjDetailsProps> = ({ packageId }) => {
  ...
  const fetchPackageDetails = async () => {
    ...
    try {
      ...
      const docRef = doc(db, 'Hajj-packages', packageId);
                                ...
                                <div className="hotel-details-section my-4 p-4 bg-light rounded">
                                    ...
                                    <div className="row mt-3">
                                        <div className="col-md-6">
                                            <h5>Makkah Hotel</h5>
                                            <p>{packageData.makkah_nights}</p>
                                        </div>
                                        <div className="col-md-6">
                                            <h5>Madinah Hotel</h5>
                                            <p>{packageData.madinah_nights}</p>
                                        </div>
                                    </div>
                                </div>
